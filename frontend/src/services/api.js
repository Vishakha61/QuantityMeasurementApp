...
// In dev, Vite proxies /api/auth (+ /oauth2, /login) to the auth-service on
// http://localhost:8080, and /api/quantity to the quantity-service on
// http://localhost:8081 (see vite.config.js).
// In prod, point VITE_API_BASE_URL at wherever these services are deployed.
